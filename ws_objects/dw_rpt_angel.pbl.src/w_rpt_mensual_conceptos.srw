$PBExportHeader$w_rpt_mensual_conceptos.srw
forward
global type w_rpt_mensual_conceptos from window
end type
type cb_salir from commandbutton within w_rpt_mensual_conceptos
end type
type cb_ultimo from commandbutton within w_rpt_mensual_conceptos
end type
type cb_anterior from commandbutton within w_rpt_mensual_conceptos
end type
type cb_siguiente from commandbutton within w_rpt_mensual_conceptos
end type
type cb_primero from commandbutton within w_rpt_mensual_conceptos
end type
type cb_cancelar from commandbutton within w_rpt_mensual_conceptos
end type
type cb_imprimir from commandbutton within w_rpt_mensual_conceptos
end type
type cb_ver from commandbutton within w_rpt_mensual_conceptos
end type
type dw_datos from datawindow within w_rpt_mensual_conceptos
end type
type em_final from editmask within w_rpt_mensual_conceptos
end type
type em_inicial from editmask within w_rpt_mensual_conceptos
end type
type st_2 from statictext within w_rpt_mensual_conceptos
end type
type st_1 from statictext within w_rpt_mensual_conceptos
end type
end forward
...
global w_rpt_mensual_conceptos w_rpt_mensual_conceptos
...
on w_rpt_mensual_conceptos.create
...
on w_rpt_mensual_conceptos.destroy
...
integer height = 1200
string title = "none"
string dataobject = "dw_rpt_mensual_conceptos"
